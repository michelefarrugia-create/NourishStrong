  ...
  return (
    <div style={{maxWidth: '400px', margin: 'auto', backgroundColor: '#daf2d1', padding: '1rem', borderRadius: '8px'}}>
      ...
      <form onSubmit={handleSubmit}>
        <label>Username:
          <input style={{width: '100%', padding: '0.5rem', margin: '0.5rem 0'}} type="text" value={username} onChange={e => setUsername(e.target.value)} />
        </label>
        <label>Password:
          <input style={{width: '100%', padding: '0.5rem', margin: '0.5rem 0'}} type="password" value={password} onChange={e => setPassword(e.target.value)} />
        </label>
        {isSignUp && (
          <>
